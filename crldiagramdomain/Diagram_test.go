...
var _ = Describe("CrlDiagramtest", func() {
	...
	Describe("Test convenience functions", func() {
		Specify("GetReferencedElement and SetReferencedElement should work", func() {
			...
			node, _ := NewDiagramNode(uOfD, trans)
		...
		Specify("GetLinkSource and SetLinkSource should work", func() {
			BuildCrlDiagramDomain(uOfD, trans)
			link, _ := NewDiagramReferenceLink(uOfD, trans)
			target, _ := uOfD.NewElement(trans)
	...
	Describe("Test New... functions", func() {
		...
		Specify("Createing a new diagram should work", func() {
			newDiagram, err := NewDiagram(uOfD, trans)
			Expect(err).To(BeNil())
		...
		Specify("Creating a new node shoud work", func() {
			newDiagramNode, err := NewDiagramNode(uOfD, trans)
			Expect(err).To(BeNil())
		...
		Specify("Creating a new reference link shoud work", func() {
			...
			Expect(crlDiagramElementModelReference).ToNot(BeNil())
			crlDiagramElementAbstractionDisplayLabel := link.GetFirstOwnedLiteralRefinedFromURI(CrlDiagramElementAbstractionDisplayLabelURI, trans)
			Expect(crlDiagramElementAbstractionDisplayLabel).ToNot(BeNil())
			crlDiagramElementDisplayLabel := link.GetFirstOwnedLiteralRefinedFromURI(CrlDiagramElementDisplayLabelURI, trans)
			Expect(crlDiagramElementDisplayLabel).ToNot(BeNil())
		...
		Specify("Creating a new ownerPointer shoud work", func() {
			...
			Expect(crlDiagramElementModelReference).ToNot(BeNil())
			crlDiagramElementAbstractionDisplayLabel := ownerPointer.GetFirstOwnedLiteralRefinedFromURI(CrlDiagramElementAbstractionDisplayLabelURI, trans)
			Expect(crlDiagramElementAbstractionDisplayLabel).ToNot(BeNil())
			crlDiagramElementDisplayLabel := ownerPointer.GetFirstOwnedLiteralRefinedFromURI(CrlDiagramElementDisplayLabelURI, trans)
			Expect(crlDiagramElementDisplayLabel).ToNot(BeNil())
		...
		Specify("Creating a new elementPointer shoud work", func() {
			...
			Expect(crlDiagramElementModelReference).ToNot(BeNil())
			crlDiagramElementAbstractionDisplayLabel := elementPointer.GetFirstOwnedLiteralRefinedFromURI(CrlDiagramElementAbstractionDisplayLabelURI, trans)
			Expect(crlDiagramElementAbstractionDisplayLabel).ToNot(BeNil())
			crlDiagramElementDisplayLabel := elementPointer.GetFirstOwnedLiteralRefinedFromURI(CrlDiagramElementDisplayLabelURI, trans)
			Expect(crlDiagramElementDisplayLabel).ToNot(BeNil())
		...
		Specify("Creating a new abstractPointer shoud work", func() {
			...
			Expect(crlDiagramElementModelReference).ToNot(BeNil())
			crlDiagramElementAbstractionDisplayLabel := abstractPointer.GetFirstOwnedLiteralRefinedFromURI(CrlDiagramElementAbstractionDisplayLabelURI, trans)
			Expect(crlDiagramElementAbstractionDisplayLabel).ToNot(BeNil())
			crlDiagramElementDisplayLabel := abstractPointer.GetFirstOwnedLiteralRefinedFromURI(CrlDiagramElementDisplayLabelURI, trans)
			Expect(crlDiagramElementDisplayLabel).ToNot(BeNil())
		...
		Specify("Creating a new refinedPointer shoud work", func() {
			...
			Expect(crlDiagramElementModelReference).ToNot(BeNil())
			crlDiagramElementAbstractionDisplayLabel := refinedPointer.GetFirstOwnedLiteralRefinedFromURI(CrlDiagramElementAbstractionDisplayLabelURI, trans)
			Expect(crlDiagramElementAbstractionDisplayLabel).ToNot(BeNil())
			crlDiagramElementDisplayLabel := refinedPointer.GetFirstOwnedLiteralRefinedFromURI(CrlDiagramElementDisplayLabelURI, trans)
			Expect(crlDiagramElementDisplayLabel).ToNot(BeNil())
